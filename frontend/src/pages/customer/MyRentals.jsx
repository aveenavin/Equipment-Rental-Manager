...
const STATUS_FILTERS = ['', 'pending', 'confirmed', 'checked_out', 'returned', 'cancelled'];
  ...
  return (
    <div className="p-6 sm:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-7">
        <div>
          <h1 className="text-2xl font-bold text-slate-100">My Rentals</h1>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-x-6 gap-y-1.5 text-xs text-slate-400">
                    ...
                    <span className="flex items-center gap-1">
                      ...
                      ${rental.totalAmount} total ({rental.totalDays} day{rental.totalDays !== 1 ? 's' : ''})
                    </span>
                  </div>
                </div>
          ...
          <div className="w-full max-w-sm bg-slate-900 border border-slate-700 rounded-2xl p-6 shadow-2xl">
            ...
            <p className="text-slate-400 text-sm mb-6">
              ...
              <span className="text-slate-200 font-medium">
                &ldquo;{cancelTarget.equipment?.name}&rdquo;
              </span>
